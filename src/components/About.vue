<template>
  <md-layout style="margin: 15px">
    <md-card
      ...
      <p> This is an interactive tool that creates a map of the risk of
      epidemic spread/cross-border incursion related to priority
      pathogens. It currently uses national populations, and
      consolidated flight data for inter-national travel patterns. </p>

      <p> Given the coarse granularity of the data, basic
      epidemiological are used to model individual countries. This is
